        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-4 text-sm text-muted-foreground leading-relaxed">
              <p>
                Pioneers CIT is the official student web platform for the
                College of Information Technology. It serves as a central hub
                for students to access academic information, news, schedules,
